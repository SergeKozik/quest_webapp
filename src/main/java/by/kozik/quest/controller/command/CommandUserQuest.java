 ...
 */
public class CommandUserQuest extends CommandDefault {
    public CommandUserQuest(HttpServletRequest request) {
        super(request);
    }
    ...
    public String execute() {
        ...
        try{
            ...
            quests = questService.showParticipatedQuestByTitle(user,userLocale);
            if (quests!=null) {
