...
/**
 * Created by Serge on 12.12.2016.
 */
public class CommandRegister extends CommandDefault {

    public CommandRegister(HttpServletRequest request) {
        super(request);
    }
    ...
    public String execute() {
        ...
        if (validator.validate(userLocale)) {
            ...
            if (rolePriority<=RoleEnum.AUTHOR.getPriority()) {
