...
<form class="question-create-form" action="/author/next-question-nomark.html">
    ...
    <div class="answer-multiple">
        ...
        <fmt:message key="message.label.answers-text" bundle="${msg}" var="msg_text"/>
...
<form action="/author/next-question-nomark.html">
