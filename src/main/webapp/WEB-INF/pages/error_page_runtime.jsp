    ...
    <div class="main">
        <div class="box content">
            <table>
                <tr>
                    <td>
                        <fmt:message key="message.error.exception-message" bundle="${msg}"/>
                    </td>
                    <td class="custom-error">
                        <c:out value="${pageContext.exception.message}"/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <fmt:message key="message.error.exception-type" bundle="${msg}"/>
                    </td>
                    <td class="custom-error">
            ...
            <fmt:message key="message.error.greeting-runtime" bundle="${msg}"/>
        </div>
    </div>
